<script lang="ts">
    ...
    function animateScroll(scrollDuration: number, scrollTarget: number, callback?: () => void) {
    ...
    function handleClick() {
      if (document.documentElement.scrollTop < document.documentElement.scrollHeight - window.innerHeight) {
        ...
        animateScroll(1000, document.documentElement.scrollHeight - window.innerHeight, function() {
